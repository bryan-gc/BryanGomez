...
import { ButtonDirective, DateInputComponent } from '../../shared';
...
export class ProductEditComponent implements OnInit, OnDestroy {
  ...
  loadProduct(id: string): void {
    this.isLoading = true;
    const loadProductSub = this.productsService.getProduct(id).subscribe({
      next: (product) => {
  ...
  onSubmit(): void {
    ...
    const updateProductSub = this.productsService
